...
public class BinarySerializerTest
{
    ...
    public void When_Using_Property_WithXContainerAssignable_should_serialize()
    {
        ...
        using (var stream = new MemoryStream())
        {
            ...
            resultXDocument = Enumerable.OfType<MessageWithXDocument>(serializer.Deserialize(stream, new[] { typeof(MessageWithXDocument) })).Single();
        }
        ...
        using (var stream = new MemoryStream())
        {
            ...
            resultXElement = Enumerable.OfType<MessageWithXElement>(serializer.Deserialize(stream, new[] { typeof(MessageWithXElement) })).Single();
        }
